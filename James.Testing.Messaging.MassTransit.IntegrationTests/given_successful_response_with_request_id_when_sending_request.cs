...
{
    [TestFixture]
    public class given_successful_response_with_request_id_when_sending_request : LoopbackLocalAndRemoteTestFixture
    {
        private Guid _id;
        ...
        public void SetUp()
        {
            ...
            Messaging
                ...
                .SendRequest<Input, Output>(RemoteUri, new Input {Id = _id}, TimeSpan.FromSeconds(30), _id);
        }
